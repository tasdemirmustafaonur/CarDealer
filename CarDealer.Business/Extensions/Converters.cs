...
namespace CarDealer.Business.Extensions
{
    public static class Converters
    {
        ...
        public static User ConvertToUser(this AddNewUserRequest request, IMapper mapper)
        {
            return mapper.Map<User>(request);
        }

        public static Vehicle ConvertToVehicle(this AddNewVehicleRequest request, IMapper mapper)
        {
            return mapper.Map<Vehicle>(request);
        }
        ...
        public static Role ConvertToEntity(this EditRoleRequest request, IMapper mapper)
        {
            return mapper.Map<Role>(request);
        }

        public static User ConvertToEntity(this EditUserRequest request, IMapper mapper)
        {
            return mapper.Map<User>(request);
        }

        public static Vehicle ConvertToEntity(this EditVehicleRequest request, IMapper mapper)
        {
            return mapper.Map<Vehicle>(request);
        }
